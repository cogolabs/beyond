...
var (
	fenceURL     = flag.String("fence-url", "", "URL to user fencing config")
	sitesURL     = flag.String("sites-url", "", "URL to allowed sites config")
	whitelistURL = flag.String("whitelist-url", "", "URL to site whitelist")
